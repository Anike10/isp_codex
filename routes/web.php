...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('permission:manage_invoices')->group(function () {
        ...
        Route::get('invoices/{invoice}/invoice.pdf', [InvoiceController::class, 'downloadPdf'])->name('invoices.pdf');
    ...
    Route::middleware('permission:manage_payments')->group(function () {
        ...
        Route::post('bkash-sms-payments/whatsapp', [BkashSmsPaymentController::class, 'whatsappSettings'])->name('bkash-sms-payments.whatsapp');
        Route::post('bkash-sms-payments/{bkashSmsPayment}/whatsapp-resend', [BkashSmsPaymentController::class, 'whatsappResend'])->name('bkash-sms-payments.whatsapp-resend');
    ...
    Route::middleware('permission:manage_mikrotik_routers')->group(function () {
        ...
        Route::post('network-map/maps', [NetworkMapController::class, 'storeMap'])->name('network-map.maps.store');
        Route::delete('network-map/maps/{networkMap}', [NetworkMapController::class, 'destroyMap'])->name('network-map.maps.destroy');
        ...
        Route::patch('olt-onus/nightly-live-sync-settings', [OltOnuController::class, 'updateNightlyLiveSyncSettings'])->name('olt-onus.nightly-live-sync-settings.update');
