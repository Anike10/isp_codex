...
class PppWebhookService
{
    ...
    public function scriptFor(MikrotikRouter $router): string
    {
        ...
        return ':local webhookUser $user;'
            ...
            .':if ([:len $webhookBytesIn] = 0 || [:len $webhookBytesOut] = 0) do={'
            ...
            .'    };'
            .'    :if ([:len $webhookBytesIn] = 0 && $ifaceRx > 0) do={:set webhookBytesIn $ifaceRx;};'
            .'    :if ([:len $webhookBytesOut] = 0 && $ifaceTx > 0) do={:set webhookBytesOut $ifaceTx;};'
            .'}'
            .':if ([:len $webhookBytesIn] = 0) do={:set webhookBytesIn 0};'
            .':if ([:len $webhookBytesOut] = 0) do={:set webhookBytesOut 0};'
