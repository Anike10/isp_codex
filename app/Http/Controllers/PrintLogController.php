...
{
    private const TYPES = ['invoice' => Invoice::class, 'delivery_challan' => Invoice::class, 'invoice_quotation' => Invoice::class, 'quotation' => Quotation::class, 'payment_voucher' => Payment::class, 'payment_thermal_voucher' => Payment::class, 'expense_voucher' => Expense::class];
