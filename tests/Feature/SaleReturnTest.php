...
class SaleReturnTest extends TestCase
{
    ...
    public function test_sale_return_restores_stock_serials_and_credits_customer_balance(): void
    {
        ...
        $this->assertEquals(2450, (float) $customer->refresh()->account_balance);
