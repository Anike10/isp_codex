...
@section('content')
    ...
    <link rel="stylesheet" href="{{ asset('css/network-map-7993e11add8f.css') }}?v=20260904-9">
    ...
    <div class="network-modal" id="featureModal" hidden>
        <form class="network-form" id="featureForm">
            ...
            <div class="form-warnings" id="formWarnings" hidden></div>
    ...
    <script src="{{ asset('js/network-map-d194101.js') }}?v=20260904-10"></script>
    <script>
        (function () {
