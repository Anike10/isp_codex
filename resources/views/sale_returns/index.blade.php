...
<table>
    <thead><tr><th>Return</th><th>Invoice</th><th>Party</th><th>Date</th><th>Goods Value</th><th>Total Credit</th><th>Invoice Credit</th><th>Advance Credit</th><th>Note</th></tr></thead>
    <tbody>
    ...
    @empty
        <tr><td colspan="9">No sale returns found.</td></tr>
    @endforelse
    </tbody>
</table>
