    ...
    <div class="header-inner">
        ...
        <nav class="nav" id="app-nav">
            @php
                ...
                $canManageTroubleshoot = collect(['troubleshoot_webhook', 'troubleshoot_frequent_disconnects', 'troubleshoot_mac_changes', 'troubleshoot_analytics', 'troubleshoot_router_data', 'troubleshoot_onu_signal', 'troubleshoot_data_usage', 'troubleshoot_data_usage_party'])->contains($canMenu);
                ...
                <details class="nav-group">
                    ...
                    <div class="nav-menu">
                        ...
                        @if ($canMenu('network_map'))
                            ...
                            <a href="{{ route('network-map.index', ['map' => 'test']) }}">Test Network Map</a>
            ...
            @if ($canManageTroubleshoot)
                <details class="nav-group">
                    ...
                    <div class="nav-menu">
                        ...
                        @endif
                        @if ($canMenu('troubleshoot_mac_changes'))
                            <a href="{{ route('troubleshoot.mac-changes') }}">Frequent MAC Changes</a>
                        @endif
                        ...
                        @endif
                        @if ($canMenu('troubleshoot_data_usage'))
                            <a href="{{ route('troubleshoot.data-usage') }}">Data Usage</a>
                        @endif
                        @if ($canMenu('troubleshoot_data_usage_party'))
                            <a href="{{ route('troubleshoot.data-usage.select') }}">Data Usage by Party</a>
                        @endif
                    </div>
                </details>
            @endif
