    ...
    <section class="rf-card">
        ...
        <div class="rf-grid">
            ...
            <div class="rf-field">
                ...
                <div class="rf-input-suffix">
                    <input id="rf-mac-interval" type="number" min="1" max="365" name="active_mac_sync_interval_days" value="{{ old('active_mac_sync_interval_days', $mikrotikRouter->active_mac_sync_interval_days ?? 1) }}" required>
                    <span>days</span>
                </div>
