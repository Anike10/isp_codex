...
- Sale-return credit settles the source invoice due first; only credit beyond that due becomes customer advance, and a fully returned unpaid invoice is marked `returned`
